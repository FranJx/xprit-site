          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <div className="flex gap-4 mt-4">
                <span className="text-cyan-400 font-semibold">Gestionar:</span>
                <button className="text-white font-semibold px-3 py-1 bg-cyan-600 rounded">Robots</button>
                <a href="/admin-menu/news" className="text-gray-400 hover:text-cyan-300 font-semibold px-3 py-1">Noticias</a>
              </div>
            </div>
            <button
